namespace HyperGames.UnityTemplate.Quests.UI
{
    ...
    public class UnityTemplateQuestChestItemModel
    {
        public UnityTemplateQuestController Quest { get; }

        public UnityTemplateQuestChestItemModel(UnityTemplateQuestController quest)
        {
            this.Quest = quest;
        }
    }

    public class UnityTemplateQuestChestItemView : MonoBehaviour
    {
        ...
        public UnityTemplateQuestChestItemModel Model { get; set; }
