namespace HyperGames.HyperCasual.GamePlay.Models
{
    ...
    [Preserve]
    public class UnityTemplateEventRacingData : ILocalData, IUnityTemplateLocalData
    {
        ...
        [OdinSerialize] public Dictionary<int, UnityTemplateRacingPlayerData> playerIndexToData = new();
        ...
        public void Init()
        {
            ...
            this.yourIndex         = new Random().Next(0, UnityTemplateEventRacingDataController.TotalRacingPlayer);
        }

        public Type ControllerType => typeof(UnityTemplateEventRacingDataController);
    }

    public class UnityTemplateRacingPlayerData
    {
        public string Name;
