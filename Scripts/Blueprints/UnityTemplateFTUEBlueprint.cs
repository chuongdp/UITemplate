namespace HyperGames.UnityTemplate.Scripts.Blueprints
{
    ...
    [Preserve]
    [BlueprintReader("UnityTemplateFTUE", true)]
    [CsvHeaderKey("Id")]
    public class UnityTemplateFTUEBlueprint : GenericBlueprintReaderByRow<string, UnityTemplateFTUERecord>
    {
    }

    [Preserve]
    public class UnityTemplateFTUERecord
    {
