namespace HyperGames.UnityTemplate.UnityTemplate.Scenes.Utils
{
    ...
    public class UnityTemplateCurrencyView : UnityTemplateFlyingAnimationView
    {
        #region inject

        private SignalBus                         signalBus;
        private UnityTemplateInventoryDataController UnityTemplateInventoryDataController;
        ...
        protected virtual void Awake()
        {
            ...
            this.UnityTemplateInventoryDataController = container.Resolve<UnityTemplateInventoryDataController>();
        ...
        private void Initialize()
        {
            ...
            this.UpdateData(this.UnityTemplateInventoryDataController.GetCurrencyValue(this.currencyId));
