namespace HyperGames.UnityTemplate.UnityTemplate.Services
{
    ...
    public class UnityTemplateAnalyticHandler : IInitializable, IDisposable
    {
        #region inject
        ...
        protected readonly UnityTemplateLevelDataController       UnityTemplateLevelDataController;
        protected readonly UnityTemplateInventoryDataController   UnityTemplateInventoryDataController;
        protected readonly UnityTemplateDailyRewardController     UnityTemplateDailyRewardController;
        protected readonly UnityTemplateGameSessionDataController UnityTemplateGameSessionDataController;

        #endregion

        [Preserve]
        public UnityTemplateAnalyticHandler(
            SignalBus                           signalBus,
        ...
        protected virtual void InterstitialAdDisplayedHandler(InterstitialAdDisplayedSignal obj)
        {
            ...
            this.Track(this.analyticEventFactory.InterstitialShow(this.UnityTemplateLevelDataController.GetCurrentLevelData.Level, obj.Placement));
        ...
        private void RewardedInterstitialAdDisplayedHandler(RewardedInterstitialAdCompletedSignal obj)
        {
            ...
            this.Track(this.analyticEventFactory.RewardedInterstitialAdDisplayed(this.UnityTemplateLevelDataController.GetCurrentLevelData.Level, obj.Placement));
        }
        ...
        private void RewardedAdDisplayedHandler(RewardedAdDisplayedSignal obj)
        {
            this.analyticServices.UserProperties[this.analyticEventFactory.LastAdsPlacementProperty] = obj.Placement;
            this.analyticServices.UserProperties[this.analyticEventFactory.TotalRewardedAdsProperty] = obj.Placement;
            this.Track(this.analyticEventFactory.RewardedVideoShow(this.UnityTemplateLevelDataController.GetCurrentLevelData.Level, obj.Placement));
        ...
        {
            var levelData = this.UnityTemplateLevelDataController.GetLevelData(obj.Level);

            this.analyticServices.UserProperties[this.analyticEventFactory.LevelMaxProperty] = this.UnityTemplateLevelDataController.MaxLevel;
        ...
        {
            this.analyticServices.UserProperties[this.analyticEventFactory.LastLevelProperty] = this.UnityTemplateLevelDataController.GetCurrentLevelData.Level;
            this.Track(this.analyticEventFactory.LevelStart(obj.Level, this.UnityTemplateInventoryDataController.GetCurrencyValue()));
        ...
        {
            if (obj.Amount > 0)
                this.analyticServices.UserProperties[this.analyticEventFactory.TotalVirtualCurrencyEarnedProperty] = this.UnityTemplateInventoryDataController.GetCurrencyData(obj.Id).TotalEarned;
            else
                this.analyticServices.UserProperties[this.analyticEventFactory.TotalVirtualCurrencySpentProperty] =
                    this.UnityTemplateInventoryDataController.GetCurrencyData(obj.Id).TotalEarned - this.UnityTemplateInventoryDataController.GetCurrencyData(obj.Id).Value;
        }
        ...
        {
            this.analyticServices.UserProperties[this.analyticEventFactory.RetentionDayProperty] = (int)(DateTime.Now.Date - this.UnityTemplateDailyRewardController.GetFirstTimeOpenedDate.Date).TotalDays;
            this.analyticServices.UserProperties[this.analyticEventFactory.DaysPlayedProperty]   = this.UnityTemplateGameSessionDataController.OpenTime;
        }
