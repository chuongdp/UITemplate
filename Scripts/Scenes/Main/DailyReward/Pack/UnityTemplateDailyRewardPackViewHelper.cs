namespace HyperGames.UnityTemplate.UnityTemplate.Scenes.Main.DailyReward.Pack
{
    ...
    public class UnityTemplateDailyRewardPackViewHelper
    {
        ...
        [Preserve]
        public UnityTemplateDailyRewardPackViewHelper(IGameAssets gameAssets, UnityTemplateDailyRewardController dailyRewardController)
        {
            this.GameAssets            = gameAssets;
            this.DailyRewardController = dailyRewardController;
        }

        public virtual async void BindDataItem(UnityTemplateDailyRewardPackModel model, UnityTemplateDailyRewardPackView view, UnityTemplateDailyRewardPackPresenter presenter)
        {
        ...
        public virtual void DisposeItem(UnityTemplateDailyRewardPackPresenter presenter)
        {
        }

        public virtual void OnClaimReward(UnityTemplateDailyRewardPackPresenter presenter)
        {
        }
    }
}