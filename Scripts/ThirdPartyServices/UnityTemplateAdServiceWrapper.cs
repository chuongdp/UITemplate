namespace HyperGames.UnityTemplate.UnityTemplate.Scripts.ThirdPartyServices
{
    ...
    public class UnityTemplateAdServiceWrapper : IInitializable, ITickable
    {
        #region inject

        private readonly IReadOnlyList<IAdServices>             adServices;
        private readonly IReadOnlyList<IMRECAdService>          mrecAdServices;
        private readonly UnityTemplateAdsController             UnityTemplateAdsController;
        private readonly UnityTemplateGameSessionDataController gameSessionDataController;
        ...
        [Preserve]
        public UnityTemplateAdServiceWrapper(
        ...
        )
        {
            ...
            this.UnityTemplateAdsController = UnityTemplateAdsController;
        ...
        public virtual async void ShowBannerAd(int width = 320, int height = 50)
        {
            ...
            this.logService.Log($"mirailog: ShowBannerAd this.adServicesConfig.EnableBannerAd {this.adServicesConfig.EnableBannerAd}");

            if (!this.adServicesConfig.EnableBannerAd) return;
            this.logService.Log($"mirailog: ShowBannerAd IsShowBannerAd {this.IsShowBannerAd}");
            if (this.IsShowBannerAd)
            {
                this.logService.Log(
                    $"mirailog: ShowBannerAd EnableCollapsibleBanner {this.adServicesConfig.EnableCollapsibleBanner}, PreviousCollapsibleBannerAdLoadedFail {this.PreviousCollapsibleBannerAdLoadedFail}");
                if (this.adServicesConfig.EnableCollapsibleBanner && !this.PreviousCollapsibleBannerAdLoadedFail)
                {
                    ...
                    this.logService.Log(
                        $"mirailog: ShowCollapsibleBannerAd refreshing: {this.IsRefreshingCollapsible}, expandOnRefresh: {this.adServicesConfig.CollapsibleBannerExpandOnRefreshEnabled}, useNewGuid: {useNewGuid}");
                ...
                else
                {
                    ...
                    this.logService.Log("mirailog: InternalShowMediationBannerAd");
                }

                this.PreviousCollapsibleBannerAdLoadedFail = false;
                this.signalBus.Fire(new UnityTemplateOnUpdateBannerStateSignal(true));
            }
        }
        ...
        public virtual void HideBannerAd()
        {
            ...
            this.InternalHideCollapsibleBannerAd();
            this.InternalHideMediationBannerAd();
            this.signalBus.Fire(new UnityTemplateOnUpdateBannerStateSignal(false));
            this.logService.Log("mirailog: HideBannerAd");
        }
        ...
        private void OnScreenChanged(IScreenPresenter screenPresenter)
        {
...
#if HYPERGAMES_COLLAPSIBLE_BANNER
            ...
            if (this.BannerLoadStrategy == BannerLoadStrategy.AfterLoading && screenPresenter is UnityTemplateLoadingScreenPresenter) return;
            this.ShowBannerAd();
#endif
        }
        ...
        private void ShowAOAAdsIfAvailable(bool isFireEligibleSignal = true)
        {
            ...
            this.logService.Log($"mirailog: AdServiceWrapper: ShowAOAAdsIfAvailable: useAdmob: {this.adServicesConfig.UseAoaAdmob} | {typeToAvailable}");
        ...
        public virtual bool IsInterstitialAdReady(string place) { return this.adServices.Any(adService => adService.IsInterstitialAdReady(place)); }
        ...
        public bool CanShowInterstitialAd(string place, bool force = false)
        {
            ...
            this.logService.Log(
                $"mirailog: ShowInterstitialAd1 {place} force {force} this.adServicesConfig.EnableInterstitialAd {isInterstitialAdEnable} this.levelDataController.CurrentLevel {this.levelDataController.CurrentLevel} this.adServicesConfig.InterstitialAdStartLevel {this.adServicesConfig.InterstitialAdStartLevel}");
            ...
            this.logService.Log(
                $"mirailog: ShowInterstitialAd2 {place} force {force} check1 {this.totalNoAdsPlayingTime < interstitialAdInterval} check2 {this.totalNoAdsPlayingTime < this.FirstInterstitialAdsDelayTime}");
        ...
        public virtual bool ShowInterstitialAd(string place, Action<bool> onShowInterstitialFinished, bool force = false)
        {
            ...
            this.logService.Log(
                $"mirailog: ShowInterstitialAd {place} - {string.Join(", ", this.adServices.Select(adService => $"{adService.GetType().Name}: {adService.IsInterstitialAdReady(place)}"))}");
            ...
            this.logService.Log($"mirailog: ShowInterstitialAd {place} - {adService.GetType().Name}");
            ...
            void InternalShowInterstitial()
            {
                ...
                this.UnityTemplateAdsController.UpdateWatchedInterstitialAds();
        ...
        public virtual void ShowRewardedAd(string place, Action onComplete, Action onFail = null)
        {
            ...
            this.logService.Log($"mirailog: ShowRewardedAd {place} - {string.Join(", ", this.adServices.Select(adService => $"{adService.GetType().Name}: {adService.IsRewardedAdReady(place)}"))}");
            ...
            this.logService.Log($"mirailog: ShowRewardedAd {place} - {adService.GetType().Name}");
            ...
            this.UnityTemplateAdsController.UpdateWatchedRewardedAds();
            this.IsResumedFromAnotherServices = true;
        ...
        public virtual bool IsRewardedAdReady(string place) { return this.adServices.Any(adService => adService.IsRewardedAdReady(place)); }
        ...
        public virtual void ShowMREC(AdViewPosition adViewPosition)
        {
            ...
            if (mrecAdService != null)
            {
                ...
                this.logService.Log($"mirailog: ShowMREC {adViewPosition}");
            }
        }
        ...
        public virtual void HideMREC(AdViewPosition adViewPosition)
        {
            ...
            if (mrecAdServices.Count > 0)
            {
                ...
                this.logService.Log($"mirailog: HideMREC {adViewPosition}");
            }
        }
