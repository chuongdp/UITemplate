namespace HyperGames.Tool.Optimization.Addressable
{
    ...
    using HyperGames.Tool.Optimization.Texture.MenuItems;
    ...
    public class BuildInScreenFinderOdin : OdinEditorWindow
    {
        ...
        [MenuItem("HyperGames/List And Optimize/Build-In Screens List")]
