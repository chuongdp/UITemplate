namespace HyperGames.UnityTemplate.UnityTemplate.Services
{
    ...
    public class UnityTemplateFlyingAnimationController
    {
        ...
        private const    string         PrefabName = "UnityTemplateFlyingAnimationItem";

        [Preserve]
        public UnityTemplateFlyingAnimationController(IScreenManager screenManager, IGameAssets gameAssets)
        {
        ...
        public async UniTask PlayAnimation<T>(RectTransform startPointRect, int minAmount = 6, int maxAmount = 10, float timeAnim = 1f, RectTransform target = null, string prefabName = "", float flyPunchPositionFactor = 0.3f)
            where T : UnityTemplateFlyingAnimationView
        {
