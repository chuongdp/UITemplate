namespace HyperGames.UnityTemplate.UnityTemplate.Scenes.Main
{
    ...
    public class UnityTemplateHomeSimpleScreenView : BaseView
    {
    ...
    [ScreenInfo(nameof(UnityTemplateHomeSimpleScreenView))]
    public class UnityTemplateHomeSimpleScreenPresenter : UnityTemplateBaseScreenPresenter<UnityTemplateHomeSimpleScreenView>
    {
        [Preserve]
        public UnityTemplateHomeSimpleScreenPresenter(
            SignalBus           signalBus,
            ILogService         logger,
