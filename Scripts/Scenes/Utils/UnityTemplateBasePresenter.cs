namespace HyperGames.UnityTemplate.Scripts.Scenes.Utils
{
    ...
    using HyperGames.UnityTemplate.Scripts.ThirdPartyServices.AnalyticEvents.CommonEvents;
    ...
    public class UnityTemplateBaseScreenUtils
    {
        ...
        public UnityTemplateBaseScreenUtils()
        {
            ...
            this.soundServices   = container.Resolve<UnityTemplateSoundServices>();
        }
        ...
        {
            UnityTemplateBaseScreenUtils.Instance ??= new();
        }
        ...
        {
            UnityTemplateBaseScreenUtils.Init();
    ...
    {
        protected UnityTemplateBaseScreenPresenter(SignalBus signalBus, ILogService logger) : base(signalBus, logger)
        {
            UnityTemplateBaseScreenUtils.Init();
        }
        ...
        protected override void OnViewReady()
        {
            ...
            #if CREATIVE
            UnityTemplateBaseScreenUtils.Instance.SetupCreativeMode(this);
            #endif
        }
    }

    public abstract class UnityTemplateBaseScreenPresenter<TView, TModel> : BaseScreenPresenter<TView, TModel> where TView : IScreenView
    {
        protected UnityTemplateBaseScreenPresenter(SignalBus signalBus, ILogService logger) : base(signalBus, logger)
        {
            UnityTemplateBaseScreenUtils.Init();
    ...
    public abstract class UnityTemplateBasePopupPresenter<TView> : BasePopupPresenter<TView> where TView : IScreenView
    {
        protected UnityTemplateBasePopupPresenter(SignalBus signalBus, ILogService logger) : base(signalBus, logger)
        {
            UnityTemplateBaseScreenUtils.Init();
        }
    ...
    public abstract class UnityTemplateBasePopupPresenter<TView, TModel> : BasePopupPresenter<TView, TModel> where TView : IScreenView
    {
        protected UnityTemplateBasePopupPresenter(SignalBus signalBus, ILogService logger) : base(signalBus, logger)
        {
            UnityTemplateBaseScreenUtils.Init();
