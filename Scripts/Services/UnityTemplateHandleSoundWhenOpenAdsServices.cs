namespace HyperGames.UnityTemplate.UnityTemplate.Services
{
    ...
    public class UnityTemplateHandleSoundWhenOpenAdsServices : IInitializable, IDisposable
    {
        private readonly SignalBus     signalBus;
        private readonly IAudioService audioManager;

        [Preserve]
        public UnityTemplateHandleSoundWhenOpenAdsServices(SignalBus signalBus, IAudioService audioManager)
        {
