namespace HyperGames.UnityTemplate.UnityTemplate.Scenes.Popups
{
    ...
    public class UnityTemplateRateGamePopupView : BaseView
    {
    ...
    [PopupInfo(nameof(UnityTemplateRateGamePopupView))]
    public class UnityTemplateRateGamePopupPresenter : UnityTemplateBasePopupPresenter<UnityTemplateRateGamePopupView>
    {
        private int lastStarCount;

        [Preserve]
        public UnityTemplateRateGamePopupPresenter(
            SignalBus                    signalBus,
            ILogService                  logger,
