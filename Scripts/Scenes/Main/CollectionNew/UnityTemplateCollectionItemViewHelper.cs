namespace HyperGames.UnityTemplate.UnityTemplate.Scenes.Main.CollectionNew
{
    ...
    public class UnityTemplateCollectionItemViewHelper
    {
        protected readonly IGameAssets                       GameAssets;
        private readonly   UnityTemplateInventoryDataController UnityTemplateInventoryDataController;

        [Preserve]
        public UnityTemplateCollectionItemViewHelper(IGameAssets gameAssets, UnityTemplateInventoryDataController UnityTemplateInventoryDataController)
        {
        ...
        {
            var isCoin      = param.ShopBlueprintRecord.UnlockType == UnityTemplateItemData.UnlockType.SoftCurrency;
            var isAds       = param.ShopBlueprintRecord.UnlockType == UnityTemplateItemData.UnlockType.Ads;
            var isIap       = param.ShopBlueprintRecord.UnlockType == UnityTemplateItemData.UnlockType.IAP;
            var isDaily     = param.ShopBlueprintRecord.UnlockType == UnityTemplateItemData.UnlockType.DailyReward;
            var isLuckySpin = param.ShopBlueprintRecord.UnlockType == UnityTemplateItemData.UnlockType.LuckySpin;
            var isStartPack = param.ShopBlueprintRecord.UnlockType == UnityTemplateItemData.UnlockType.StartedPack;

            var isOwner    = param.ItemData.CurrentStatus == UnityTemplateItemData.Status.Owned;
            var isUnlocked = param.ItemData.CurrentStatus == UnityTemplateItemData.Status.Unlocked;
            var isLocked   = param.ItemData.CurrentStatus == UnityTemplateItemData.Status.Locked;
        ...
        protected virtual bool IsItemBuyCoinAble(ItemCollectionItemModel param)
        {
            ...
            var currentCoin = this.UnityTemplateInventoryDataController.GetCurrencyValue(param.ShopBlueprintRecord.CurrencyID);
