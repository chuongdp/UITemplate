namespace HyperGames.UnityTemplate.Scripts.Blueprints
{
    ...
    [Preserve]
    [BlueprintReader("UnityTemplateLevel", true)]
    public class UnityTemplateLevelBlueprint : GenericBlueprintReaderByRow<int, UnityTemplateLevelRecord>
    {
    }

    [Preserve]
    [CsvHeaderKey("Level")]
    public class UnityTemplateLevelRecord
    {
