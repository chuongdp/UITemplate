namespace HyperGames.UnityTemplate.Quests.UI
{
    ...
    public class UnityTemplateQuestPopupView : BaseView
    {
        ...
        [field: SerializeField] public UnityTemplateQuestListView         ListView    { get; private set; }
        [field: SerializeField] public UnityTemplateQuestChestView        ChestView   { get; private set; }
        [field: SerializeField] public UnityTemplateQuestPopupTabButton[] TabButtons  { get; private set; }
    }

    [PopupInfo(nameof(UnityTemplateQuestPopupView))]
    public class UnityTemplateQuestPopupPresenter : UnityTemplateBasePopupPresenter<UnityTemplateQuestPopupView>
    {
        #region Inject
        ...
        #if hypergames_BADGE_NOTIFY
        private readonly UnityTemplateBadgeNotifySystem badgeNotifySystem;
        #endif

        [Preserve]
        public UnityTemplateQuestPopupPresenter(
            SignalBus              signalBus,
            ILogService            logger,
            UnityTemplateQuestManager questManager
            #if hypergames_BADGE_NOTIFY
            , UnityTemplateBadgeNotifySystem badgeNotifySystem
            #endif
        ...
        protected override void OnViewReady()
        {
            ...
            this.View.TabButtons.ForEach(tabButton =>
            {
                ...
                #if hypergames_BADGE_NOTIFY
                this.badgeNotifySystem.RegisterBadge(tabButton.GetComponent<UnityTemplateBadgeNotifyView>(), this, () => this.CheckBadgeNotifyOnTabButton(tabButton));
                #endif
            });
        ...
        #if hypergames_BADGE_NOTIFY
        private bool CheckBadgeNotifyOnTabButton(UnityTemplateQuestPopupTabButton tabButton)
        {
