namespace HyperGames.UnityTemplate.UnityTemplate.Scenes.Leaderboard
{
    ...
    public class UnityTemplateLeaderboardItemModel
    {
        public int    Rank;
        ...
        public UnityTemplateLeaderboardItemModel(int rank, Sprite countryFlag, string name, bool isYou)
        {
            this.Rank        = rank;
    ...
    public class UnityTemplateLeaderboardItemView : TViewMono
    {
    ...
    public class UnityTemplateLeaderboardItemPresenter : BaseUIItemPresenter<UnityTemplateLeaderboardItemView, UnityTemplateLeaderboardItemModel>
    {
        [Preserve]
        public UnityTemplateLeaderboardItemPresenter(IGameAssets gameAssets) : base(gameAssets)
        {
        }

        public override void BindData(UnityTemplateLeaderboardItemModel param)
        {
