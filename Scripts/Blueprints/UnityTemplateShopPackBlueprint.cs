namespace HyperGames.UnityTemplate.Scripts.Blueprints
{
    ...
    [Preserve]
    [BlueprintReader("UnityTemplateShopPack", true)]
    public class UnityTemplateShopPackBlueprint : GenericBlueprintReaderByRow<string, ShopPackRecord>
    {
    ...
    public class ShopPackRecord
    {
        ...
        public BlueprintByRow<string, UnityTemplateRewardBlueprintData> RewardIdToRewardDatas { get; [Preserve] private set; }
    }

    [Preserve]
    [CsvHeaderKey("RewardId")]
    public class UnityTemplateRewardBlueprintData
    {
