namespace HyperGames.UnityTemplate.Quests
{
    ...
    using HyperGames.UnityTemplate.Quests.UI;
    ...
    public class UnityTemplateQuestNotificationView : MonoBehaviour
    {
        ...
        private UnityTemplateGameSessionDataController gameSessionDataController;
        ...
        private void Awake()
        {
            ...
            this.gameSessionDataController = container.Resolve<UnityTemplateGameSessionDataController>();
        ...
        private void Start()
        {
            this.btn.onClick.AddListener(() => this.screenManager.OpenScreen<UnityTemplateQuestPopupPresenter>().Forget());
