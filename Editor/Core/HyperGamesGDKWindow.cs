namespace HyperGames.Tool.Core
{
    ...
    public class HyperGamesWindow : OdinEditorWindow
    {
        [MenuItem("HyperGames/Configuration And Tools")]
        private static void OpenWindow()
        {
            GetWindow<HyperGamesWindow>().Show();
        }
