namespace HyperGames.UnityTemplate.UnityTemplate.Scenes.BottomBarNavigator
{
    ...
    public abstract class UnityTemplateBottomNavigatorBarView : MonoBehaviour
    {
        #region inject

        protected SignalBus                  signalBus;
        protected UnityTemplateAdServiceWrapper UnityTemplateAdServiceWrapper;
        ...
        protected virtual void OnChangeBarState(bool isActive)
        {
            ...
            {
                if (isActive)
                    this.UnityTemplateAdServiceWrapper.HideBannerAd();
                else
                    this.UnityTemplateAdServiceWrapper.ShowBannerAd();
            }
        }
        ...
        protected virtual void Awake()
        {
            ...
            this.UnityTemplateAdServiceWrapper = container.Resolve<UnityTemplateAdServiceWrapper>();
        ...
        private int Height => this.UnityTemplateAdServiceWrapper.IsRemovedAds || !this.gameFeaturesSetting.showBottomBarWithBanner ? this.NoBannerHeight : this.HasBannerHeight;
    }
}